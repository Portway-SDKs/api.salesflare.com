...
export class GetMe200ResponseRolePermissions {
    'view'?: GetMe200ResponseRolePermissions.ViewEnum;
    'ced'?: GetMe200ResponseRolePermissions.CedEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "view",
            "baseName": "view",
            "type": "GetMe200ResponseRolePermissions.ViewEnum"
        },
        {
            "name": "ced",
            "baseName": "ced",
            "type": "GetMe200ResponseRolePermissions.CedEnum"
        }    ];

    static getAttributeTypeMap() {
        return GetMe200ResponseRolePermissions.attributeTypeMap;
    }
}

export namespace GetMe200ResponseRolePermissions {
