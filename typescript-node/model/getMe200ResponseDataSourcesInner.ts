...
export class GetMe200ResponseDataSourcesInner {
    'id'?: number;
    'email'?: string;
    'type'?: string;
    'syncStatus'?: string;
    'status'?: GetMe200ResponseDataSourcesInner.StatusEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "GetMe200ResponseDataSourcesInner.StatusEnum"
        },
        {
            "name": "statusMessage",
    ...
    static getAttributeTypeMap() {
        return GetMe200ResponseDataSourcesInner.attributeTypeMap;
    }
}

export namespace GetMe200ResponseDataSourcesInner {
