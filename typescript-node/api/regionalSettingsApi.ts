...
export enum RegionalSettingsApiApiKeys {
}

export class RegionalSettingsApi {
    ...
    public setApiKey(key: RegionalSettingsApiApiKeys, value: string) {
        (this.authentications as any)[RegionalSettingsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async getCurrencies (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<GetCurrencies200ResponseInner>;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<GetCurrencies200ResponseInner>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<GetCurrencies200ResponseInner>");
