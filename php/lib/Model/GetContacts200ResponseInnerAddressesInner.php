...
/**
 * GetContacts200ResponseInnerAddressesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetContacts200ResponseInnerAddressesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getContacts_200_response_inner_addresses_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('state_region', $data ?? [], null);
    ...
    */
     ...
     * Sets region
     *
     * @param string|null $region Deprecated property. Use state_region instead.
     *
     * @return self
     */
     ...
     * Sets state_region
     *
     * @param string|null $state_region state_region
     *
     * @return self
     */
    public function setStateRegion($state_region)
    {
        if (is_null($state_region)) {
            throw new \InvalidArgumentException('non-nullable state_region cannot be null');
        }
