...
class GetMe200ResponseRole(BaseModel):
    """
    GetMe200ResponseRole
    """ # noqa: E501
    id: Optional[Union[StrictFloat, StrictInt]] = None
    name: Optional[StrictStr] = None
    permissions: Optional[GetMe200ResponseRolePermissions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "permissions": GetMe200ResponseRolePermissions.from_dict(obj["permissions"]) if obj.get("permissions") is not None else None
        })
        return _obj
