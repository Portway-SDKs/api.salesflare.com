...
class GetMe200ResponseTeamEmailTrackingDomain(BaseModel):
    """
    GetMe200ResponseTeamEmailTrackingDomain
    """ # noqa: E501
    url: StrictStr
    enabled: StrictBool
    time_zones: Optional[List[StrictStr]] = Field(default=None, alias="timeZones")
    __properties: ClassVar[List[str]] = ["url", "enabled", "timeZones"]
