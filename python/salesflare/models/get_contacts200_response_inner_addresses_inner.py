...
class GetContacts200ResponseInnerAddressesInner(BaseModel):
    """
    ...
    region: Optional[StrictStr] = Field(default=None, description="Deprecated property. Use state_region instead.")
    state_region: Optional[StrictStr] = None
    street: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    zip: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "city", "country", "region", "state_region", "street", "type", "zip"]
