...
class GetMe200ResponseDataSourcesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "email", "type", "sync_status", "status", "status_message"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['ERROR', 'RECONNECT', 'OK']):
            raise ValueError("must be one of enum values ('ERROR', 'RECONNECT', 'OK')")
        return value
