...
class GetMe200ResponseFlagsInner(BaseModel):
    """
    GetMe200ResponseFlagsInner
    """ # noqa: E501
    id: Optional[Union[StrictFloat, StrictInt]] = None
    flag: Union[StrictFloat, StrictInt]
    name: StrictStr
    state: StrictBool
    ...
    __properties: ClassVar[List[str]] = ["id", "flag", "name", "state", "user", "plan", "creation_date", "modification_date"]
