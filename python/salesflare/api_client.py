...
from salesflare.api_response import ApiResponse, T as ApiResponseT
import salesflare.models
from salesflare import rest
from salesflare.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(salesflare.models, klass)
