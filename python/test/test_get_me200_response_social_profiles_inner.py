...
class TestGetMe200ResponseSocialProfilesInner(unittest.TestCase):
    """GetMe200ResponseSocialProfilesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMe200ResponseSocialProfilesInner:
        """Test GetMe200ResponseSocialProfilesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMe200ResponseSocialProfilesInner`
        """
        model = GetMe200ResponseSocialProfilesInner()
        if include_optional:
            return GetMe200ResponseSocialProfilesInner(
                id = 1.337,
                username = '',
                url = '',
                type = ''
    ...
    def testGetMe200ResponseSocialProfilesInner(self):
        """Test GetMe200ResponseSocialProfilesInner"""
