...
class TestGetContacts200ResponseInnerSocialProfilesInner(unittest.TestCase):
    """GetContacts200ResponseInnerSocialProfilesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetContacts200ResponseInnerSocialProfilesInner:
        """Test GetContacts200ResponseInnerSocialProfilesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetContacts200ResponseInnerSocialProfilesInner`
        """
        model = GetContacts200ResponseInnerSocialProfilesInner()
        if include_optional:
            return GetContacts200ResponseInnerSocialProfilesInner(
                id = 1.337,
                type = '',
                url = '',
                username = ''
    ...
    def testGetContacts200ResponseInnerSocialProfilesInner(self):
        """Test GetContacts200ResponseInnerSocialProfilesInner"""
