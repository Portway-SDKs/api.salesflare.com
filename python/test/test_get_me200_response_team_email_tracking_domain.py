...
class TestGetMe200ResponseTeamEmailTrackingDomain(unittest.TestCase):
    """GetMe200ResponseTeamEmailTrackingDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMe200ResponseTeamEmailTrackingDomain:
        """Test GetMe200ResponseTeamEmailTrackingDomain
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMe200ResponseTeamEmailTrackingDomain`
        """
        model = GetMe200ResponseTeamEmailTrackingDomain()
        if include_optional:
            return GetMe200ResponseTeamEmailTrackingDomain(
                url = '',
                enabled = True,
                time_zones = [
                    ''
    ...
    def testGetMe200ResponseTeamEmailTrackingDomain(self):
        """Test GetMe200ResponseTeamEmailTrackingDomain"""
