...
class TestGetMe200ResponseDataSourcesToReconnectInner(unittest.TestCase):
    """GetMe200ResponseDataSourcesToReconnectInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMe200ResponseDataSourcesToReconnectInner:
        """Test GetMe200ResponseDataSourcesToReconnectInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMe200ResponseDataSourcesToReconnectInner`
        """
        model = GetMe200ResponseDataSourcesToReconnectInner()
        if include_optional:
            return GetMe200ResponseDataSourcesToReconnectInner(
                id = 1.337,
                email = '',
                type = ''
            )
    ...
    def testGetMe200ResponseDataSourcesToReconnectInner(self):
        """Test GetMe200ResponseDataSourcesToReconnectInner"""
