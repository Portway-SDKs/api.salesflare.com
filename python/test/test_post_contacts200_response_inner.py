...
class TestPostContacts200ResponseInner(unittest.TestCase):
    """PostContacts200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostContacts200ResponseInner:
        """Test PostContacts200ResponseInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostContacts200ResponseInner`
        """
        model = PostContacts200ResponseInner()
        if include_optional:
    ...
    def testPostContacts200ResponseInner(self):
        """Test PostContacts200ResponseInner"""
