...
class TestGetContacts200ResponseInnerTagsInner(unittest.TestCase):
    """GetContacts200ResponseInnerTagsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetContacts200ResponseInnerTagsInner:
        """Test GetContacts200ResponseInnerTagsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetContacts200ResponseInnerTagsInner`
        """
        model = GetContacts200ResponseInnerTagsInner()
        if include_optional:
            return GetContacts200ResponseInnerTagsInner(
                id = 1.337,
                name = ''
            )
        else:
    ...
    def testGetContacts200ResponseInnerTagsInner(self):
        """Test GetContacts200ResponseInnerTagsInner"""
