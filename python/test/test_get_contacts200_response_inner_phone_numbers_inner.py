...
class TestGetContacts200ResponseInnerPhoneNumbersInner(unittest.TestCase):
    """GetContacts200ResponseInnerPhoneNumbersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetContacts200ResponseInnerPhoneNumbersInner:
        """Test GetContacts200ResponseInnerPhoneNumbersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetContacts200ResponseInnerPhoneNumbersInner`
        """
        model = GetContacts200ResponseInnerPhoneNumbersInner()
        if include_optional:
            return GetContacts200ResponseInnerPhoneNumbersInner(
                id = 1.337,
                number = '',
                type = ''
            )
    ...
    def testGetContacts200ResponseInnerPhoneNumbersInner(self):
        """Test GetContacts200ResponseInnerPhoneNumbersInner"""
