...
class TestGetMe200ResponseTeamCurrency(unittest.TestCase):
    """GetMe200ResponseTeamCurrency unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMe200ResponseTeamCurrency:
        """Test GetMe200ResponseTeamCurrency
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMe200ResponseTeamCurrency`
        """
        model = GetMe200ResponseTeamCurrency()
        if include_optional:
            return GetMe200ResponseTeamCurrency(
                id = 1.337,
                html = '',
                iso = ''
            )
    ...
    def testGetMe200ResponseTeamCurrency(self):
        """Test GetMe200ResponseTeamCurrency"""
