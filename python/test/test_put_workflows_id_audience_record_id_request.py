...
class TestPutWorkflowsIdAudienceRecordIdRequest(unittest.TestCase):
    """PutWorkflowsIdAudienceRecordIdRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutWorkflowsIdAudienceRecordIdRequest:
        """Test PutWorkflowsIdAudienceRecordIdRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutWorkflowsIdAudienceRecordIdRequest`
        """
        model = PutWorkflowsIdAudienceRecordIdRequest()
        if include_optional:
            return PutWorkflowsIdAudienceRecordIdRequest(
                exited = True,
                met_goal = True
            )
        else:
    ...
    def testPutWorkflowsIdAudienceRecordIdRequest(self):
        """Test PutWorkflowsIdAudienceRecordIdRequest"""
