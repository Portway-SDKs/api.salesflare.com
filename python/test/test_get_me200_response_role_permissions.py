...
class TestGetMe200ResponseRolePermissions(unittest.TestCase):
    """GetMe200ResponseRolePermissions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMe200ResponseRolePermissions:
        """Test GetMe200ResponseRolePermissions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMe200ResponseRolePermissions`
        """
        model = GetMe200ResponseRolePermissions()
        if include_optional:
            return GetMe200ResponseRolePermissions(
                view = 'CED',
                ced = 'CED'
            )
        else:
    ...
    def testGetMe200ResponseRolePermissions(self):
        """Test GetMe200ResponseRolePermissions"""
