...
class TestGetCurrencies200ResponseInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCurrencies200ResponseInner:
        """Test GetCurrencies200ResponseInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCurrencies200ResponseInner`
        """
        model = GetCurrencies200ResponseInner()
        if include_optional:
