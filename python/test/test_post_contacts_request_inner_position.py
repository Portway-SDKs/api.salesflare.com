...
class TestPostContactsRequestInnerPosition(unittest.TestCase):
    """PostContactsRequestInnerPosition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostContactsRequestInnerPosition:
        """Test PostContactsRequestInnerPosition
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostContactsRequestInnerPosition`
        """
        model = PostContactsRequestInnerPosition()
        if include_optional:
            return PostContactsRequestInnerPosition(
                organisation = '',
                role = ''
            )
        else:
    ...
    def testPostContactsRequestInnerPosition(self):
        """Test PostContactsRequestInnerPosition"""
