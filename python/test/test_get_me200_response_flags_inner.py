...
class TestGetMe200ResponseFlagsInner(unittest.TestCase):
    """GetMe200ResponseFlagsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMe200ResponseFlagsInner:
        """Test GetMe200ResponseFlagsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMe200ResponseFlagsInner`
        """
        model = GetMe200ResponseFlagsInner()
        if include_optional:
            return GetMe200ResponseFlagsInner(
                id = 1.337,
                flag = 1.337,
                name = '',
                state = True,
    ...
    def testGetMe200ResponseFlagsInner(self):
        """Test GetMe200ResponseFlagsInner"""
