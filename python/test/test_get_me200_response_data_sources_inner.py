...
class TestGetMe200ResponseDataSourcesInner(unittest.TestCase):
    """GetMe200ResponseDataSourcesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMe200ResponseDataSourcesInner:
        """Test GetMe200ResponseDataSourcesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMe200ResponseDataSourcesInner`
        """
        model = GetMe200ResponseDataSourcesInner()
        if include_optional:
            return GetMe200ResponseDataSourcesInner(
                id = 1.337,
                email = '',
                type = '',
                sync_status = '',
    ...
    def testGetMe200ResponseDataSourcesInner(self):
        """Test GetMe200ResponseDataSourcesInner"""
