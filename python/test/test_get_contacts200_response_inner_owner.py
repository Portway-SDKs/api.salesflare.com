...
class TestGetContacts200ResponseInnerOwner(unittest.TestCase):
    """GetContacts200ResponseInnerOwner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetContacts200ResponseInnerOwner:
        """Test GetContacts200ResponseInnerOwner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetContacts200ResponseInnerOwner`
        """
        model = GetContacts200ResponseInnerOwner()
        if include_optional:
            return GetContacts200ResponseInnerOwner(
                id = 1.337,
                name = '',
                email = '',
                picture = ''
    ...
    def testGetContacts200ResponseInnerOwner(self):
        """Test GetContacts200ResponseInnerOwner"""
