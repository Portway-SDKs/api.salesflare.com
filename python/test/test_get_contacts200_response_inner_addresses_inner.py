...
class TestGetContacts200ResponseInnerAddressesInner(unittest.TestCase):
    """GetContacts200ResponseInnerAddressesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetContacts200ResponseInnerAddressesInner:
        """Test GetContacts200ResponseInnerAddressesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetContacts200ResponseInnerAddressesInner`
        """
        model = GetContacts200ResponseInnerAddressesInner()
        if include_optional:
            return GetContacts200ResponseInnerAddressesInner(
                id = 1.337,
                city = '',
                country = '',
                region = '',
    ...
    def testGetContacts200ResponseInnerAddressesInner(self):
        """Test GetContacts200ResponseInnerAddressesInner"""
