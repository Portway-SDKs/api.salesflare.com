...
class TestPostContactsRequestInnerPhoneNumbersInner(unittest.TestCase):
    """PostContactsRequestInnerPhoneNumbersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostContactsRequestInnerPhoneNumbersInner:
        """Test PostContactsRequestInnerPhoneNumbersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostContactsRequestInnerPhoneNumbersInner`
        """
        model = PostContactsRequestInnerPhoneNumbersInner()
        if include_optional:
            return PostContactsRequestInnerPhoneNumbersInner(
                number = '',
                type = ''
            )
        else:
    ...
    def testPostContactsRequestInnerPhoneNumbersInner(self):
        """Test PostContactsRequestInnerPhoneNumbersInner"""
