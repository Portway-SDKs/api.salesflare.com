...
class TestPostContactsRequestInnerAddress(unittest.TestCase):
    """PostContactsRequestInnerAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostContactsRequestInnerAddress:
        """Test PostContactsRequestInnerAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostContactsRequestInnerAddress`
        """
        model = PostContactsRequestInnerAddress()
        if include_optional:
            return PostContactsRequestInnerAddress(
                city = '',
                country = '',
                region = '',
                state_region = '',
    ...
    def testPostContactsRequestInnerAddress(self):
        """Test PostContactsRequestInnerAddress"""
