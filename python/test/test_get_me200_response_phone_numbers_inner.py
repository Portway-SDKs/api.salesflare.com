...
class TestGetMe200ResponsePhoneNumbersInner(unittest.TestCase):
    """GetMe200ResponsePhoneNumbersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMe200ResponsePhoneNumbersInner:
        """Test GetMe200ResponsePhoneNumbersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMe200ResponsePhoneNumbersInner`
        """
        model = GetMe200ResponsePhoneNumbersInner()
        if include_optional:
            return GetMe200ResponsePhoneNumbersInner(
                id = 1.337,
                number = '',
                type = ''
            )
    ...
    def testGetMe200ResponsePhoneNumbersInner(self):
        """Test GetMe200ResponsePhoneNumbersInner"""
