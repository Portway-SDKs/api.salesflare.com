...
public class WorkflowsApiTest {
     ...
     */
    @Test
    public void putWorkflowsIdAudienceRecordIdTest() throws ApiException {
        BigDecimal id = null;
        BigDecimal recordId = null;
        PutWorkflowsIdAudienceRecordIdRequest body = null;
        PutWorkflowsIdAudienceRecordId200Response response = api.putWorkflowsIdAudienceRecordId(id, recordId, body);
