...
/**
 * API tests for RegionalSettingsApi
 */
@Disabled
public class RegionalSettingsApiTest {

    private final RegionalSettingsApi api = new RegionalSettingsApi();
    ...
    public void getCurrenciesTest() throws ApiException {
        List<GetCurrencies200ResponseInner> response = api.getCurrencies();
