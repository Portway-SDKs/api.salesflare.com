...
public class ContactsApiTest {
    ...
    public void getContactsTest() throws ApiException {
        ...
        String domain = null;
        OffsetDateTime modificationAfter = null;
        OffsetDateTime modificationBefore = null;
        OffsetDateTime creationAfter = null;
        OffsetDateTime creationBefore = null;
        List<BigDecimal> account = null;
        List<BigDecimal> tag = null;
        List<String> tagName = null;
        List<String> positionRole = null;
        List<String> addressCountry = null;
        List<String> addressStateRegion = null;
        List<String> addressCity = null;
        ...
        String q = null;
        List<GetContacts200ResponseInner> response = api.getContacts(id, name, email, phoneNumber, domain, modificationAfter, modificationBefore, creationAfter, creationBefore, account, tag, tagName, positionRole, addressCountry, addressStateRegion, addressCity, includeArchived, search, type, limit, offset, custom, orderBy, q);
    ...
    public void postContactsTest() throws ApiException {
        Boolean force = null;
        List<PostContactsRequestInner> body = null;
        List<PostContacts200ResponseInner> response = api.postContacts(force, body);
        // TODO: test validations
    }
