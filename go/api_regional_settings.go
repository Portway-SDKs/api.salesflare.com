...
// RegionalSettingsAPIService RegionalSettingsAPI service
type RegionalSettingsAPIService service

type ApiGetCurrenciesRequest struct {
	ctx context.Context
	ApiService *RegionalSettingsAPIService
}
...
*/
func (a *RegionalSettingsAPIService) GetCurrencies(ctx context.Context) ApiGetCurrenciesRequest {
	return ApiGetCurrenciesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *RegionalSettingsAPIService) GetCurrenciesExecute(r ApiGetCurrenciesRequest) ([]GetCurrencies200ResponseInner, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RegionalSettingsAPIService.GetCurrencies")
	if err != nil {
