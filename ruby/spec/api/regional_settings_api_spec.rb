...
# Unit tests for OpenapiClient::RegionalSettingsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RegionalSettingsApi' do
  before do
  ...
  describe 'test an instance of RegionalSettingsApi' do
    it 'should create an instance of RegionalSettingsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::RegionalSettingsApi)
    end
  end
