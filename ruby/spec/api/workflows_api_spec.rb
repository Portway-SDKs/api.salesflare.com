...
describe 'WorkflowsApi' do
  ...
  # unit tests for put_workflows_id_audience_record_id
  # Re-enter or exit an entity from a workflow
  # @param id 
  # @param record_id This is the entity id. For email workflows this should be the contact id.
  # @param [Hash] opts the optional parameters
  # @option opts [PutWorkflowsIdAudienceRecordIdRequest] :body 
  # @return [PutWorkflowsIdAudienceRecordId200Response]
  describe 'put_workflows_id_audience_record_id test' do
    it 'should work' do
