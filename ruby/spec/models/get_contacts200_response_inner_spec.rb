...
# Unit tests for OpenapiClient::GetContacts200ResponseInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetContacts200ResponseInner do
  let(:instance) { OpenapiClient::GetContacts200ResponseInner.new }

  describe 'test an instance of GetContacts200ResponseInner' do
    it 'should create an instance of GetContacts200ResponseInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetContacts200ResponseInner)
    end
  end
  ...
  describe 'test attribute "not_viewed"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "last_email_date"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "last_meeting_date"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
