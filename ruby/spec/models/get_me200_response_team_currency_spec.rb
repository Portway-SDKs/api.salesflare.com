...
# Unit tests for OpenapiClient::GetMe200ResponseTeamCurrency
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetMe200ResponseTeamCurrency do
  let(:instance) { OpenapiClient::GetMe200ResponseTeamCurrency.new }

  describe 'test an instance of GetMe200ResponseTeamCurrency' do
    it 'should create an instance of GetMe200ResponseTeamCurrency' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetMe200ResponseTeamCurrency)
    end
  end
