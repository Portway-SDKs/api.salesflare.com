...
# Unit tests for OpenapiClient::PostContacts200ResponseInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostContacts200ResponseInner do
  let(:instance) { OpenapiClient::PostContacts200ResponseInner.new }

  describe 'test an instance of PostContacts200ResponseInner' do
    it 'should create an instance of PostContacts200ResponseInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostContacts200ResponseInner)
    end
  end
