...
# Unit tests for OpenapiClient::GetMe200ResponseDataSourcesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetMe200ResponseDataSourcesInner do
  let(:instance) { OpenapiClient::GetMe200ResponseDataSourcesInner.new }

  describe 'test an instance of GetMe200ResponseDataSourcesInner' do
    it 'should create an instance of GetMe200ResponseDataSourcesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetMe200ResponseDataSourcesInner)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ERROR", "RECONNECT", "OK"])
