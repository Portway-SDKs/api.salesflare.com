...
# Unit tests for OpenapiClient::GetMe200ResponseFlagsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetMe200ResponseFlagsInner do
  let(:instance) { OpenapiClient::GetMe200ResponseFlagsInner.new }

  describe 'test an instance of GetMe200ResponseFlagsInner' do
    it 'should create an instance of GetMe200ResponseFlagsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetMe200ResponseFlagsInner)
    end
  end
