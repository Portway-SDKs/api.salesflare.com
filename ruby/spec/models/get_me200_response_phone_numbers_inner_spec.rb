...
# Unit tests for OpenapiClient::GetMe200ResponsePhoneNumbersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetMe200ResponsePhoneNumbersInner do
  let(:instance) { OpenapiClient::GetMe200ResponsePhoneNumbersInner.new }

  describe 'test an instance of GetMe200ResponsePhoneNumbersInner' do
    it 'should create an instance of GetMe200ResponsePhoneNumbersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetMe200ResponsePhoneNumbersInner)
    end
  end
