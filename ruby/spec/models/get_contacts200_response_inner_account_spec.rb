...
# Unit tests for OpenapiClient::GetContacts200ResponseInnerAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetContacts200ResponseInnerAccount do
  let(:instance) { OpenapiClient::GetContacts200ResponseInnerAccount.new }

  describe 'test an instance of GetContacts200ResponseInnerAccount' do
    it 'should create an instance of GetContacts200ResponseInnerAccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetContacts200ResponseInnerAccount)
    end
  end
