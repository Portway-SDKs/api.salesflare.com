...
# Unit tests for OpenapiClient::GetContacts200ResponseInnerAddressesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetContacts200ResponseInnerAddressesInner do
  let(:instance) { OpenapiClient::GetContacts200ResponseInnerAddressesInner.new }

  describe 'test an instance of GetContacts200ResponseInnerAddressesInner' do
    it 'should create an instance of GetContacts200ResponseInnerAddressesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetContacts200ResponseInnerAddressesInner)
    end
  end
