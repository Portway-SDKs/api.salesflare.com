...
# Unit tests for OpenapiClient::GetContacts200ResponseInnerPositionsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetContacts200ResponseInnerPositionsInner do
  let(:instance) { OpenapiClient::GetContacts200ResponseInnerPositionsInner.new }

  describe 'test an instance of GetContacts200ResponseInnerPositionsInner' do
    it 'should create an instance of GetContacts200ResponseInnerPositionsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetContacts200ResponseInnerPositionsInner)
    end
  end
