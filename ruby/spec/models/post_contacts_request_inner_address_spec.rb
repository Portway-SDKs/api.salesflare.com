...
# Unit tests for OpenapiClient::PostContactsRequestInnerAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostContactsRequestInnerAddress do
  let(:instance) { OpenapiClient::PostContactsRequestInnerAddress.new }

  describe 'test an instance of PostContactsRequestInnerAddress' do
    it 'should create an instance of PostContactsRequestInnerAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostContactsRequestInnerAddress)
    end
  end
