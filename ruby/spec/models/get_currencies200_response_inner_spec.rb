...
# Unit tests for OpenapiClient::GetCurrencies200ResponseInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetCurrencies200ResponseInner do
  let(:instance) { OpenapiClient::GetCurrencies200ResponseInner.new }

  describe 'test an instance of GetCurrencies200ResponseInner' do
    it 'should create an instance of GetCurrencies200ResponseInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetCurrencies200ResponseInner)
    end
  end
