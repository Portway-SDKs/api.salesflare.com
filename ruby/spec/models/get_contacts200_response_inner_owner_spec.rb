...
# Unit tests for OpenapiClient::GetContacts200ResponseInnerOwner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetContacts200ResponseInnerOwner do
  let(:instance) { OpenapiClient::GetContacts200ResponseInnerOwner.new }

  describe 'test an instance of GetContacts200ResponseInnerOwner' do
    it 'should create an instance of GetContacts200ResponseInnerOwner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetContacts200ResponseInnerOwner)
    end
  end
