...
# Unit tests for OpenapiClient::GetMe200ResponseRole
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetMe200ResponseRole do
  let(:instance) { OpenapiClient::GetMe200ResponseRole.new }

  describe 'test an instance of GetMe200ResponseRole' do
    it 'should create an instance of GetMe200ResponseRole' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetMe200ResponseRole)
    end
  end
