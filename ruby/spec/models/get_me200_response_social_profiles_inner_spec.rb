...
# Unit tests for OpenapiClient::GetMe200ResponseSocialProfilesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetMe200ResponseSocialProfilesInner do
  let(:instance) { OpenapiClient::GetMe200ResponseSocialProfilesInner.new }

  describe 'test an instance of GetMe200ResponseSocialProfilesInner' do
    it 'should create an instance of GetMe200ResponseSocialProfilesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetMe200ResponseSocialProfilesInner)
    end
  end
