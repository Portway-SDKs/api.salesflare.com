...
# Unit tests for OpenapiClient::PostContactsRequestInnerPosition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostContactsRequestInnerPosition do
  let(:instance) { OpenapiClient::PostContactsRequestInnerPosition.new }

  describe 'test an instance of PostContactsRequestInnerPosition' do
    it 'should create an instance of PostContactsRequestInnerPosition' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostContactsRequestInnerPosition)
    end
  end
